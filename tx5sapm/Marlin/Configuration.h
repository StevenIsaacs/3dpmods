...
#define X_BED_SIZE 340 // Large enough to enable Z sync gcode.
...
/**
 * It is sometimes more convenient to move the display to the rear
 * of the printer. This has the effect of making the X and Y seem backward.
 * Enable this to make the X and Y movement more intuitive on the movement
 * screen.
 */
#define UI_DISPLAY_AT_REAR

/**
 * On corexy machines the bed moves instead of the gantry in the Z axis.
 * This can cause the Z axis movement to seem backward.
 * Enable this to make the Z axis more intuitive on the movement screen.
 */
#define UI_Z_COREXY
